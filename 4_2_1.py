...
class Game:
    ...
    def draw(self):
        ...
        elif self.training_state == "options":
    ...
    """def feeding_button_is_clicked(self, pos):
        if not self.is_in_game_menu and self.feeding_state == "default":
            return self.feeding_button_is_clicked(pos)
        elif self.feeding_state == "options":
            return feed_hay_button.is_clicked(pos) or feed_bran_button.is_clicked(pos) or feed_hc_button.is_clicked(pos)
        else:
            return """
